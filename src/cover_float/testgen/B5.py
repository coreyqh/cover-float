...
def tests_conversion_3_4(lp, hp, rounding_mode, test_f, cover_f):
    ...
    if(hp == FMT_SINGLE and lp == FMT_BF16):
        ...
        for bits in grs:
            ...
            genTestVectors3_4(lp, hp, rounding_mode, hp_e_bits, lp_sn_exp, full_mantissa_1, full_mantissa_2, hp_e_bias, test_f, cover_f)
    else:
        ...
        complete_binary_1 = f"{random.randint(0, max_mantissa):0{remaining_mantissa_bits}b}"#randomize the rest of the number
...
def tests_conversion_5_6(lp, hp, rounding_mode, test_f, cover_f):
    ...
    #MinNorm - 2 i_ulp:
    hp_m_1 = '1'*(lp_m_bits) + '1' + '1' +  '0'*rem_bits
    hp_m_2 = '1'*(lp_m_bits) + '1' + '1' +  '0'*rem_bits
    hp_exp = lp_sn_exp
    
    genTestVectors3_4(lp, hp, rounding_mode, hp_e_bits, hp_exp, hp_m_1, hp_m_2, hp_e_bias, test_f, cover_f)
    
    #MinNorm - 3 i_ulp:
    hp_m_1 = '1'*(lp_m_bits) + '1' + '0' +  f"{random.randint(1, max_rem):0{rem_bits}b}"
    hp_m_2 = '1'*(lp_m_bits) + '1' + '0' +  f"{random.randint(1, max_rem):0{rem_bits}b}"
    hp_exp = lp_sn_exp
    
    genTestVectors3_4(lp, hp, rounding_mode, hp_e_bits, hp_exp, hp_m_1, hp_m_2, hp_e_bias, test_f, cover_f)
    
    #MinNorm + 1 i_ulp:
    hp_m_1 = '0'*(lp_m_bits - 1) + '0' + '0' + f"{random.randint(1, max_rem):0{rem_bits}b}"
    hp_m_1 = '0'*(lp_m_bits - 1) + '0' + '0' + f"{random.randint(1, max_rem):0{rem_bits}b}"
    hp_exp = lp_n_exp
    ...
    #MinNorm + 2 i_ulp:
    hp_m_1 = '0'*(lp_m_bits - 1) + '0' + '1' + '0'*rem_bits
    hp_m_1 = '0'*(lp_m_bits - 1) + '0' + '1' + '0'*rem_bits
    hp_exp = lp_n_exp
    ...
    #MinNorm + 3 i_ulp:
    hp_m_1 = '0'*(lp_m_bits - 1) + '0' + '1' + f"{random.randint(1, max_rem):0{rem_bits}b}"
    hp_m_1 = '0'*(lp_m_bits - 1) + '0' + '1' + f"{random.randint(1, max_rem):0{rem_bits}b}"
    hp_exp = lp_n_exp
