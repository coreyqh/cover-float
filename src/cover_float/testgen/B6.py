    ...
    for rounding_mode in ROUNDING_MODES:
        ...
        for exp in [min_sn_exp, t_min_sn_exp]:
            for sign in [0, 1]:
                ...
                for grs_bin in grs:
                    mul_div_grs_gen(OP_MUL, precision, rounding_mode, grs_bin, exp, sign, test_f, cover_f, "1/2", True)
                    mul_div_grs_gen(OP_DIV, precision, rounding_mode, grs_bin, exp, sign, test_f, cover_f, "1/2", True)
